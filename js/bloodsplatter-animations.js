...
// Uses GSAP and ScrollTrigger for organic splatter reveals

// Register GSAP ScrollTrigger plugin (if not already registered)
if (typeof gsap !== 'undefined' && gsap.ScrollTrigger) {
    gsap.registerPlugin(ScrollTrigger);
}

// Initialize bloodsplatter animations when DOM is loaded
...
// Particle system removed - keeping just the reveal animation
...
window.BloodsplatterAnimations = {
    init: initBloodsplatterAnimations,
